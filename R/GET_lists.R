...
#' @param content_type MIME type (aka internet media type) used to override the content type returned by the server. See \url{http://en.wikipedia.org/wiki/Internet_media_type} for a list of common types.
...
get_lists <- function(apikey = NULL,
  ...
  GETdata <- httr::content(GETdata, type = content_type)
